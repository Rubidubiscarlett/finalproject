/*do {
  ...
  if (
    typeof (numCard.length == 0 || numCard) === 'NaN' ||
    arr[0] == ' ' ||
    numCard == ''
  ) {
    ...
    if (typeof parseInt(arr[0]) == 'number') {
      console.log('Datos no validos');
      console.log('el numero de su tarjeta ingresada es: ' + numCard);
      ...
      var isValidCard = function(numCard) {
        ...
        //me sirve para separar cada digito del numero que en este caso esta en cadena y mostrarlo en un array
        var arr = numCard.split('');
        //invierte el array
